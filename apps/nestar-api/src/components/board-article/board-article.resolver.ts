...
export class BoardArticleResolver {
    ...
    public async createBoardArticle(@Args('input') input:BoardArticleInput,
    ...
    @Args('articleId') input: string,
     @AuthMember("_id") memberId: ObjectId,
       ...
       return await this.boardArticleService.getBoardArticle(memberId, propertyId);
    ...
    @UseGuards(AuthGuard)
    @Mutation((returns)=> BoardArticle)
    public async updateBoardArticle(@Args('input') input: BoardArticleUpdate,
     @AuthMember("_id")memberId: ObjectId
    ): Promise<BoardArticle>{
